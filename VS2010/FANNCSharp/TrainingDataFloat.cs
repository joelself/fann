    ...
    public class TrainingDataFloat : IDisposable
    {
        ...
        */
        ...
        /* Property: InputAccessor
            ...
            Returns:
                A <FloatArrayAccessor> that can access the input arrray

            See also:
                <Input>, <SetTrainData>
        */
        public FloatArrayAccessor InputAccessor
        {
            get
            {
                return FloatArrayAccessor.FromPointer(InternalData.get_input());
            }
        }
        ...
        */
        ...
        /* Property: OutputAccessor
            ...
            Returns:
                A <FloatArrayAccessor> that can access the output arrray

            See also:
                <Output>, <SetTrainData>
        */
        public FloatArrayAccessor OutputAccessor
        {
            get
            {
                return FloatArrayAccessor.FromPointer(InternalData.get_output());
            }
        }
