...
namespace FannWrapper
{
    public class NeuralNet : IDisposable
    {
        ...
        public void CascadetrainOnData(TrainingData data, uint max_neurons, uint neurons_between_reports, float desired_error)
        {
        ...
        public void ScaleTrain(training_data data)
        {
            net.scale_train(data);
        }
        public void DescaleTrain(training_data data)
        {
            net.descale_train(data);
        }
        public bool SetInputScalingParams(training_data data, float new_input_min, float new_input_max)
        {
            return net.set_input_scaling_params(data, new_input_min, new_input_max);
        }
        public bool SetOutputScalingParams(training_data data, float new_output_min, float new_output_max)
        {
            return net.set_output_scaling_params(data, new_output_min, new_output_max);
        }
        public bool SetScalingParams(training_data data, float new_input_min, float new_input_max, float new_output_min, float new_output_max)
        {
            return net.set_scaling_params(data, new_input_min, new_input_max, new_output_min, new_output_max);
        }
        ...
        {
            SWIGTYPE_p_FILE file = SwigFann.fopen(filename, mode);
