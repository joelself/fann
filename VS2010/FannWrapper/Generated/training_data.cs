...
public class training_data : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          FannWrapperPINVOKE.delete_training_data(swigCPtr);
        }
  ...
  public training_data() : this(FannWrapperPINVOKE.new_training_data__SWIG_0(), true) {
  }

  public training_data(training_data data) : this(FannWrapperPINVOKE.new_training_data__SWIG_1(training_data.getCPtr(data)), true) {
  ...
  public void destroy_train() {
    FannWrapperPINVOKE.training_data_destroy_train(swigCPtr);
  }

  public bool read_train_from_file(string filename) {
    bool ret = FannWrapperPINVOKE.training_data_read_train_from_file(swigCPtr, filename);
    if (FannWrapperPINVOKE.SWIGPendingException.Pending) throw FannWrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool save_train(string filename) {
    bool ret = FannWrapperPINVOKE.training_data_save_train(swigCPtr, filename);
    if (FannWrapperPINVOKE.SWIGPendingException.Pending) throw FannWrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool save_train_to_fixed(string filename, uint decimal_point) {
    bool ret = FannWrapperPINVOKE.training_data_save_train_to_fixed(swigCPtr, filename, decimal_point);
    if (FannWrapperPINVOKE.SWIGPendingException.Pending) throw FannWrapperPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void shuffle_train_data() {
    FannWrapperPINVOKE.training_data_shuffle_train_data(swigCPtr);
  }

  public void merge_train_data(training_data data) {
    FannWrapperPINVOKE.training_data_merge_train_data(swigCPtr, training_data.getCPtr(data));
    if (FannWrapperPINVOKE.SWIGPendingException.Pending) throw FannWrapperPINVOKE.SWIGPendingException.Retrieve();
  }

  public uint length_train_data() {
    uint ret = FannWrapperPINVOKE.training_data_length_train_data(swigCPtr);
    return ret;
  }

  public uint num_input_train_data() {
    uint ret = FannWrapperPINVOKE.training_data_num_input_train_data(swigCPtr);
    return ret;
  }

  public uint num_output_train_data() {
    uint ret = FannWrapperPINVOKE.training_data_num_output_train_data(swigCPtr);
    return ret;
  }

  public SWIGTYPE_p_p_float get_input() {
    global::System.IntPtr cPtr = FannWrapperPINVOKE.training_data_get_input(swigCPtr);
  ...
  public SWIGTYPE_p_p_float get_output() {
    global::System.IntPtr cPtr = FannWrapperPINVOKE.training_data_get_output(swigCPtr);
    SWIGTYPE_p_p_float ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_p_float(cPtr, false);
    return ret;
  }
  ...
  public void set_train_data(uint num_data, uint num_input, SWIGTYPE_p_float input, uint num_output, SWIGTYPE_p_float output) {
    FannWrapperPINVOKE.training_data_set_train_data__SWIG_1(swigCPtr, num_data, num_input, SWIGTYPE_p_float.getCPtr(input), num_output, SWIGTYPE_p_float.getCPtr(output));
  }
  ...
  public void scale_input_train_data(float new_min, float new_max) {
    FannWrapperPINVOKE.training_data_scale_input_train_data(swigCPtr, new_min, new_max);
  }

  public void scale_output_train_data(float new_min, float new_max) {
    FannWrapperPINVOKE.training_data_scale_output_train_data(swigCPtr, new_min, new_max);
  }

  public void scale_train_data(float new_min, float new_max) {
    FannWrapperPINVOKE.training_data_scale_train_data(swigCPtr, new_min, new_max);
  }
